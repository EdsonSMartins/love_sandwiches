...
def validate_data(values):
    """
    Inside the try, converts all string values into intenfer.
...
def get_last_5_entries_sales():
    ...
    the last 5 entries for each sandwich and return data 
    as a list of lists
    """
...
def calculate_stock_data(data):
    ...
    new_stock_data = []
    for colum in data:
        int_colum = [int(num) for num in colum]
